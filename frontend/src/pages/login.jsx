  ...
  return (
    ...
    <Navbar/>
      ...
      >
        ...
        <div className="col-md-6"  id="Loginimg" style={{background:'linear-gradient(89deg, #03045e 4%, #0077b6 91%)',padding:"3rem"}} >
          <img src={LoginImg} id="loginimg1" alt="" style={{height:"80%"}}/>
        </div>
      </section>
    </>
  );
